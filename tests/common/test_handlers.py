...
Tests for BaseHandler, AnalysisHandler, and RemediationHandler.
"""
...
class TestAnalysisHandler:
    ...
    def test_determine_action_high_confidence(self, handler):
        ...
        from src.common.models.analysis_result import AnalysisResult, AnalysisDetails
...
class TestRemediationHandler:
    ...
    def test_execute_action_notify(self, handler, sample_anomaly_data):
        ...
        from src.common.models.analysis_result import RemediationAction, ActionType
