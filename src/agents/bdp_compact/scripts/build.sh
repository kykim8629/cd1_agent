...
#   - bdp_compact-*.whl     # Python wheel package
#   - bdp-compact-layer.zip # AWS Lambda layer
...
print_help() {
    ...
    echo ""
    echo "Output directory: \$REPO_ROOT/dist/bdp_compact/"
    echo ""
    echo "Examples:"
    echo "  $0              # Full build"
...
clean_artifacts() {
    ...
    rm -rf build/ *.egg-info bdp_compact.egg-info .layer_build/
