...
from bdp_compact.handler import BDPCompactHandler
from bdp_compact.services.multi_account_provider import create_provider
...
def create_bdp_compact_app() -> FastAPI:
