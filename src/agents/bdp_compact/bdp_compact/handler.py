...
from bdp_compact.services.event_publisher import EventPublisher
from bdp_compact.services.multi_account_provider import (
    create_provider,
    BaseMultiAccountProvider,
)
from bdp_compact.services.summary_generator import SummaryGenerator

logger = logging.getLogger(__name__)


class BDPCompactHandler:
    """
    ...
    def _init_services(self) -> None:
        ...
        self.logger.info(
            f"BDPCompactHandler initialized: provider={provider_type}, "
...
# Lambda entry point
handler_instance = BDPCompactHandler()
