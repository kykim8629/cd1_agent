...
from bdp_compact.services.anomaly_detector import CostDriftResult, Severity
from bdp_compact.services.summary_generator import AlertSummary
...
class EventPublisher:
    ...
    def __init__(
        ...
        source: str = "cd1-agent.bdp-compact",
...
class LocalStackEventPublisher(EventPublisher):
    ...
    def __init__(
        ...
        super().__init__(
            event_bus=event_bus or "bdp-compact-events",
