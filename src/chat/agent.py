...
from src.chat.nodes.act import create_act_node
from src.chat.nodes.observe import create_observe_node
from src.chat.nodes.reflect import create_reflect_node
from src.chat.nodes.human_review import human_review_node, process_approval_response
from src.chat.nodes.respond import create_respond_node
...
class ChatAgent:
    ...
    def _state_dict_to_chat_state(self, state_dict: ChatStateDict) -> ChatState:
        ...
        if state_dict.get("pending_approval"):
            from src.chat.state import ApprovalRequest
